...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	wire.Build(
		...
		// Application struct
		wire.Struct(new(Application), "Server", "Health", "PromptAudit", "PluginManager", "Cleanup"),
	)
	return nil, nil
}
...
func provideCleanup(
	...
	paymentMonthlyResetCardDelivery *service.PaymentMonthlyResetCardDeliveryService,
	paymentRefundReconciliation *service.PaymentRefundReconciliationService,
	...
	return func() {
		...
		parallelSteps := []cleanupStep{
			...
			{"ProxyTimezoneBackfillService", func() error {
				if proxyTimezoneBackfill != nil {
					proxyTimezoneBackfill.Stop()
				}
				return nil
			}},
			...
			{"PaymentMonthlyResetCardDeliveryService", func() error {
				if paymentMonthlyResetCardDelivery != nil {
					paymentMonthlyResetCardDelivery.Stop()
				}
				return nil
			}},
			{"PaymentRefundReconciliationService", func() error {
				if paymentRefundReconciliation != nil {
					paymentRefundReconciliation.Stop()
				}
				return nil
			}},
			...
			{"FeishuPaymentIncidentService", func() error {
				if feishuPaymentIncidents != nil {
					feishuPaymentIncidents.Stop()
				}
				return nil
			}},
