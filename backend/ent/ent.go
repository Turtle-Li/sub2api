...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			accountpool.Table:                   accountpool.ValidColumn,
			...
			paymentinvoicedocument.Table:        paymentinvoicedocument.ValidColumn,
			paymentinvoicerequest.Table:         paymentinvoicerequest.ValidColumn,
