...
func init() {
	...
	// groupDescSubscriptionProductCode is the schema descriptor for subscription_product_code field.
	groupDescSubscriptionProductCode := groupFields[12].Descriptor()
	// group.SubscriptionProductCodeValidator is a validator for the "subscription_product_code" field. It is called by the builders before save.
	group.SubscriptionProductCodeValidator = groupDescSubscriptionProductCode.Validators[0].(func(string) error)
	...
	paymentorderDescRefundRequestedAmount := paymentorderFields[24].Descriptor()
	...
	// proxyDescDetectedTimezone is the schema descriptor for detected_timezone field.
	proxyDescDetectedTimezone := proxyFields[11].Descriptor()
	// proxy.DetectedTimezoneValidator is a validator for the "detected_timezone" field. It is called by the builders before save.
	proxy.DetectedTimezoneValidator = proxyDescDetectedTimezone.Validators[0].(func(string) error)
	...
	usagelogDescCurrency := usagelogFields[27].Descriptor()
	...
	// usagelog.CurrencyValidator is a validator for the "currency" field. It is called by the builders before save.
	usagelog.CurrencyValidator = func() func(string) error {
		validators := usagelogDescCurrency.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	// userDescWalletAvailablePaid is the schema descriptor for wallet_available_paid field.
	userDescWalletAvailablePaid := userFields[5].Descriptor()
	// user.DefaultWalletAvailablePaid holds the default value on creation for the wallet_available_paid field.
	user.DefaultWalletAvailablePaid = userDescWalletAvailablePaid.Default.(float64)
	// userDescWalletFrozenPaid is the schema descriptor for wallet_frozen_paid field.
	userDescWalletFrozenPaid := userFields[6].Descriptor()
	// user.DefaultWalletFrozenPaid holds the default value on creation for the wallet_frozen_paid field.
	user.DefaultWalletFrozenPaid = userDescWalletFrozenPaid.Default.(float64)
	// userDescWalletComponentVersion is the schema descriptor for wallet_component_version field.
	userDescWalletComponentVersion := userFields[7].Descriptor()
	// user.DefaultWalletComponentVersion holds the default value on creation for the wallet_component_version field.
	user.DefaultWalletComponentVersion = userDescWalletComponentVersion.Default.(int64)
