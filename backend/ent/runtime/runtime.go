...
func init() {
	...
	// usersubscriptionDescPlatform is the schema descriptor for platform field.
	usersubscriptionDescPlatform := usersubscriptionFields[2].Descriptor()
	// usersubscription.DefaultPlatform holds the default value on creation for the platform field.
	usersubscription.DefaultPlatform = usersubscriptionDescPlatform.Default.(string)
	// usersubscription.PlatformValidator is a validator for the "platform" field. It is called by the builders before save.
	usersubscription.PlatformValidator = usersubscriptionDescPlatform.Validators[0].(func(string) error)
	// usersubscriptionDescStatus is the schema descriptor for status field.
	usersubscriptionDescStatus := usersubscriptionFields[8].Descriptor()
