...
func TestLoadDefaultOpenAIWSConfig(t *testing.T) {
	...
	if cfg.Gateway.OpenAIWS.ClientReadLimitBytes != DefaultOpenAIWSClientReadLimitBytes {
		t.Fatalf("Gateway.OpenAIWS.ClientReadLimitBytes = %d, want %d", cfg.Gateway.OpenAIWS.ClientReadLimitBytes, DefaultOpenAIWSClientReadLimitBytes)
	}
