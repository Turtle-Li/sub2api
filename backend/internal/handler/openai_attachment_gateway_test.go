...
func (f *fakeResponsesAttachmentOptimizer) RehydrateFromCache(_ context.Context, _ []byte) attachmentgateway.Result {
	return f.result
}
...
func (f *fakeResponsesAttachmentURLExternalizer) ExternalizeWithWriteGuard(_ context.Context, _ []byte, _ func() bool) attachmentgateway.URLResult {
	f.calls++
	return f.result
}

func (f *fakeResponsesAttachmentURLExternalizer) ExternalizeSelected(_ context.Context, _ []byte, _ []int) attachmentgateway.URLResult {
	f.calls++
	return f.result
}

func (f *fakeResponsesAttachmentURLExternalizer) ExternalizeSelectedWithWriteGuard(_ context.Context, _ []byte, _ []int, _ func() bool) attachmentgateway.URLResult {
	f.calls++
	return f.result
}
...
func TestOptimizeResponsesAttachmentsUsesOnlyPrivacySafeLogFields(t *testing.T) {
	...
	require.Equal(t, int64(0), entries[0].ContextMap()["cache_lookup_count"])
...
func (o *deadlineResponsesAttachmentOptimizer) RehydrateFromCache(_ context.Context, body []byte) attachmentgateway.Result {
