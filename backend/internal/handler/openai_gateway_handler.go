...
// SetRetryProtectionRedis wires the distributed state store after provider construction.
func (h *OpenAIGatewayHandler) SetRetryProtectionRedis(redisClient *redis.Client) {
	if h == nil {
		return
	}
