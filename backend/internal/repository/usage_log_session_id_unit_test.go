...
// is immediately before native_compaction_v2; currency precedes created_at.
func TestPrepareUsageLogInsert_SessionIDArgWiring(t *testing.T) {
	...
	// created_at is last; currency is penultimate; native_compaction_v2 and
	// session_id precede it.
	...
	require.Equal(t, "text", usageLogInsertArgTypes[len(usageLogInsertArgTypes)-2],
		"currency arg type must be text")
}
