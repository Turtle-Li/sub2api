...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers, stepUpAuth middleware.StepUpAuthMiddleware) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.GET("/:id/pinned-turn-states", h.Admin.Account.GetPinnedCodexTurnStates)
		accounts.PUT("/:id/pinned-turn-states", h.Admin.Account.SetPinnedCodexTurnStates)
		accounts.DELETE("/:id/pinned-turn-states/:model", h.Admin.Account.DeletePinnedCodexTurnState)
		accounts.DELETE("/:id/pinned-turn-states", h.Admin.Account.DeleteAllPinnedCodexTurnStates)
...
func registerProxyPoolRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	pools := admin.Group("/proxy-pools")
	{
		...
		pools.POST("/members/remove", h.Admin.ProxyPool.RemoveMembers)
		pools.GET("/:id", h.Admin.ProxyPool.Get)
		pools.PUT("/:id", h.Admin.ProxyPool.Update)
		pools.DELETE("/:id", h.Admin.ProxyPool.Delete)
		pools.POST("/:id/members", h.Admin.ProxyPool.AddMembers)
		pools.GET("/:id/proxy-ids", h.Admin.ProxyPool.ListProxyIDs)
	}
}
...
func registerSettingsRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	adminSettings := admin.Group("/settings")
	{
		...
		adminSettings.GET("/unified-payment-binding", h.Admin.Setting.GetUnifiedPaymentBinding)
		adminSettings.POST("/unified-payment-binding", h.Admin.Setting.BindUnifiedPayment)
		adminSettings.DELETE("/unified-payment-binding", h.Admin.Setting.UseManualUnifiedPayment)
		...
		// 钱包结算货币配置
		adminSettings.GET("/pricing-currency", h.Admin.Setting.GetPricingCurrencySettings)
		adminSettings.PUT("/pricing-currency", h.Admin.Setting.UpdatePricingCurrencySettings)
		// 流超时处理配置
...
func registerSubscriptionRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	subscriptions := admin.Group("/subscriptions")
	{
		...
		subscriptions.POST("/reset-cards/grant", h.Admin.Subscription.GrantResetCards)
		subscriptions.POST("/:id/reset-cards/grant", h.Admin.Subscription.GrantResetCardsToSubscription)
