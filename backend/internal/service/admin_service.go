...
type AdminService interface {
	...
	ListProxiesWithAccountCount(ctx context.Context, page, pageSize int, protocol, status, search string, poolID int64, sortBy, sortOrder string) ([]ProxyWithAccountCount, int64, error)
