...
const (
	...
	// false users can no longer buy or browse subscriptions from the UI and new
	// subscription payment orders are rejected server-side; existing subscription
	// billing and admin subscription management are unaffected. Together with
	// BALANCE_PAYMENT_DISABLED it forms the admin "site billing mode" selector.
