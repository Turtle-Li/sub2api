...
func TestOpenAIUpstreamAccessStateClassification(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			err := newOpenAIUpstreamFailoverError(nil, http.StatusForbidden, nil, body, "", true)
...
func TestOpenAIHTTPAccessStateDoesNotTrustBadRequestMessage(t *testing.T) {
	...
	err := newOpenAIUpstreamFailoverError(nil, http.StatusBadRequest, nil, body, "", false)
...
func TestOpenAICapacityFailoverCarriesSafeTerminalResponse(t *testing.T) {
	...
	err := newOpenAIUpstreamFailoverError(nil, http.StatusBadRequest, nil, body, message, false)
