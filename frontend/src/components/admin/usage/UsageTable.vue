        ...
        <div class="space-y-1.5">
          ...
          <div class="mb-2 border-b border-gray-700 pb-1.5">
            ...
            <div v-if="tooltipData && tooltipData.input_cost > 0" class="flex items-center justify-between gap-4">
              ...
              <span class="font-medium text-white">{{ usageCurrencySymbol(tooltipData) }}{{ tooltipData.input_cost.toFixed(8) }}</span>
            </div>
            <div v-if="tooltipData && hasImageInputCost(tooltipData)" class="flex items-center justify-between gap-4">
              ...
              <span class="font-medium text-fuchsia-300">{{ usageCurrencySymbol(tooltipData) }}{{ tooltipData.image_input_cost.toFixed(8) }}</span>
            </div>
            <div v-if="tooltipData && tooltipData.output_cost > 0" class="flex items-center justify-between gap-4">
              <span class="text-gray-400">{{ t('admin.usage.outputCost') }}</span>
              <span class="font-medium text-white">{{ usageCurrencySymbol(tooltipData) }}{{ tooltipData.output_cost.toFixed(8) }}</span>
            </div>
            <div v-if="tooltipData && hasImageOutputCost(tooltipData)" class="flex items-center justify-between gap-4">
              ...
              <span class="font-medium text-pink-300">{{ usageCurrencySymbol(tooltipData) }}{{ tooltipData.image_output_cost.toFixed(8) }}</span>
            </div>
            ...
            <template v-else-if="tooltipData && isImageUsage(tooltipData)">
              ...
              <div class="flex items-center justify-between gap-4">
                ...
                <span class="font-medium text-sky-300">{{ usageCurrencySymbol(tooltipData) }}{{ imageUnitPrice(tooltipData).toFixed(8) }}</span>
              </div>
              <div class="flex items-center justify-between gap-4">
                <span class="text-gray-400">{{ t('usage.imageTotalPrice') }}</span>
                <span class="font-medium text-white">{{ usageCurrencySymbol(tooltipData) }}{{ tooltipData.total_cost?.toFixed(8) || '0.00000000' }}</span>
              </div>
            </template>
            <div v-else class="flex items-center justify-between gap-4">
              <span class="text-gray-400">{{ t('usage.unitPrice') }}</span>
              <span class="font-medium text-sky-300">{{ usageCurrencySymbol(tooltipData) }}{{ tooltipData?.total_cost?.toFixed(8) || '0.00000000' }}</span>
            </div>
            <div v-if="tooltipData && tooltipData.cache_creation_cost > 0" class="flex items-center justify-between gap-4">
              <span class="text-gray-400">{{ t('admin.usage.cacheCreationCost') }}</span>
              <span class="font-medium text-white">{{ usageCurrencySymbol(tooltipData) }}{{ tooltipData.cache_creation_cost.toFixed(8) }}</span>
            </div>
            <div v-if="tooltipData && tooltipData.cache_read_cost > 0" class="flex items-center justify-between gap-4">
              <span class="text-gray-400">{{ t('admin.usage.cacheReadCost') }}</span>
              <span class="font-medium text-white">{{ usageCurrencySymbol(tooltipData) }}{{ tooltipData.cache_read_cost.toFixed(8) }}</span>
            </div>
          </div>
          <!-- Rate and Summary -->
          ...
          <div class="flex items-center justify-between gap-6">
            ...
            <span class="font-semibold text-green-400">{{ usageCurrencySymbol(tooltipData) }}{{ tooltipData?.actual_cost?.toFixed(8) || '0.00000000' }}</span>
          </div>
