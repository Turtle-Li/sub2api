    ...
    ops: {
      ...
      alertRules: {
        ...
        metrics: {
          ...
          cpu: 'CPU Usage (%)',
          memory: 'Memory Usage (%)',
          networkBandwidthUtilization: 'Inbound/Outbound Bandwidth Utilization (%)',
          networkSaturationSuspected: 'Suspected Bandwidth Saturation',
        ...
        metricDescriptions: {
          ...
          networkBandwidthUtilization: 'Uses the higher value of inbound/outbound utilization; either direction crossing the threshold triggers the alert. Requires a manual limit in the bandwidth card.',
          networkSaturationSuspected: 'Compatibility boolean metric for old rules; new rules should use inbound/outbound bandwidth utilization.',
        ...
        hints: {
          ...
          bandwidthLimitRequired: 'Configure an inbound or outbound limit in the Public Bandwidth card first.'
        },
        table: {
          name: 'Name',
          metric: 'Metric',
        ...
        validation: {
          ...
          bandwidthLimitRequired: 'Bandwidth utilization alerts require an inbound or outbound limit first',
      ...
      concurrency: {
        ...
        disabledHint: 'Near-realtime monitoring is disabled in settings.',
        empty: 'No data',
        queued: 'Queue {count}',
      ...
      network: {
        ...
        tx: 'Outbound',
        limit: 'Limit',
        rxLimit: 'Inbound Limit',
        txLimit: 'Outbound Limit',
        settings: 'Bandwidth Settings',
        iface: 'Interface',
        source: 'Limit source',
        unconfigured: 'No limit set',
        noLimitShort: 'No limit',
        observing: 'Observing',
        manualLimit: 'Manual limit',
        suspectedShort: 'Suspected',
        disabledHint: 'Near-realtime monitoring is disabled in settings.',
        empty: 'No bandwidth samples yet',
        loadFailed: 'Failed to load bandwidth data',
        settingsLoadFailed: 'Failed to load bandwidth settings',
        settingsSaveSuccess: 'Bandwidth settings saved',
        settingsSaveFailed: 'Failed to save bandwidth settings',
        invalidSettings: 'Enter valid bandwidth limits.',
        enableMonitor: 'Enable bandwidth monitor',
        enableMonitorHint: 'Sample inbound/outbound traffic from server network counters every 5 seconds.',
        retryProtection: 'Experimental: abnormal retry protection',
        retryProtectionHint: 'When an inbound or outbound limit is configured and either direction crosses the threshold, repeated identical large requests are temporarily limited.',
        retryRecommendedTitle: 'Recommended settings for most small-bandwidth servers',
        retryRecommendedBody: 'Start with 90% / 60 seconds / 1 allowed retry. It does not block occasional large requests; it only acts when bandwidth is already near the configured limit and the same large body is retried repeatedly.',
        retryUseRecommended: 'Use recommended',
        retryFormula: 'Formula: repeat budget = smaller bandwidth limit × 1,000,000 ÷ 8 × window seconds × trigger percent; candidate threshold = max(min threshold, repeat budget ÷ (allowed repeats + 2)).',
        retryBudget: 'Repeat budget',
        retryBudgetHint: 'Calculated from {direction} {limit} Mbps',
        retryCandidate: 'Actual candidate threshold',
        retryCandidateHint: 'Dynamic threshold: {dynamic}',
        retryBlockRule: 'Blocking rule',
        retryBlockAttempt: 'May block from attempt {count}',
        retryBlockRuleHint: 'Bandwidth congestion, identical body, and total repeated bytes over budget are all required.',
        retryNeedsLimitHint: 'Set an inbound or outbound bandwidth limit first; this area will then show the real budget and candidate threshold for the current settings.',
        retryTriggerPercent: 'Enable when bandwidth exceeds',
        retryMinBody: 'Minimum detection threshold',
        retryAutoBodyHint: 'The minimum detection threshold is not a fixed blocking limit. It is only a floor; the real fingerprint threshold grows automatically from the formula above. Current floor: {min} MB.',
        retryProtectionWarning: 'On low-spec servers or during concurrent large requests, enabling this experiment can increase CPU usage and request latency. Raise the minimum candidate body size or disable the experiment if it affects traffic.',
        retryWindow: 'Repeat observation window',
        retryMaxRepeats: 'Allowed repeat count',
        limitPlaceholder: 'Leave empty for no limit alert',
        ifacePlaceholder: 'Auto-detect default interface',
        ifaceAuto: 'Auto-detect (current: {iface})',
        ifaceUnknown: 'unknown',
        ifaceHint: 'Usually keep auto-detect. Choose manually only for multi-interface hosts or container deployments where detection is wrong.',
        defaultIface: 'default',
        manualLimitHint: 'Bandwidth alerts only use the limits configured here. Without limits, the panel shows near-realtime traffic samples only and utilization alerts remain unavailable.',
        avg1m: '1m avg',
        avg5m: '5m avg',
        peak1h: '1h peak',
        packetWarning: 'Network drops or errors were detected.',
        status: {
          ok: 'OK',
          warning: 'Warning',
          critical: 'Critical',
