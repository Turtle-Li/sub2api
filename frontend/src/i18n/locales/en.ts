  ...
  admin: {
    ...
    ops: {
      ...
      network: {
        ...
        retryTriggerPercent: 'Bandwidth trigger',
        retryMinBody: 'Min candidate body',
        retryAutoBodyHint: 'The request-body threshold is calculated automatically from the configured inbound/outbound limit, repeat window, and allowed attempts. Higher bandwidth permits larger single request bodies.',
        ...
        retryWindow: 'Repeat window',
        retryMaxRepeats: 'Allowed attempts',
