export default {
    accounts: {
      ...
      proxyPool: {
        ...
        ssoHint: 'Only Grok SSO imports use this pool; each successful Grok account keeps its selected proxy.'
      },
      pools: {
        title: 'Account Pools',
        create: 'New pool',
        createTitle: 'Create account pool',
        editTitle: 'Edit account pool',
        edit: 'Edit pool',
        name: 'Pool name',
        platform: 'Platform',
        platformHint: 'A pool only holds accounts of one platform and cannot be changed later. Groups, proxies and scheduling stay on each account.',
        notes: 'Notes',
        saved: 'Account pool saved',
        saveFailed: 'Failed to save account pool',
        loadFailed: 'Failed to load account pools',
        stats: {
          total: 'All',
          normal: 'Normal',
          rateLimited: 'Rate limited',
        ...
        usageUpdated: 'Usage updated {time} (refreshed about every minute)',
        grokFreeQuota: 'Free quota',
        grokFreeHint: 'Tokens used by Grok Free accounts in this pool within the quota window / total quota',
        codexQuota: 'Codex avg usage',
        exhausted: '{count} exhausted',
        nearLimit: '{count} near limit',
        editAllMembers: 'Edit all members',
        purgeError: 'Purge error accounts ({count})',
        purgeErrorTitle: 'Purge error accounts',
        purgeErrorConfirm: 'This deletes {count} accounts in error state from the pool and cannot be undone. Continue?',
        dissolve: 'Dissolve pool',
        dissolveTitle: 'Dissolve account pool',
        dissolveConfirm: 'After dissolving "{name}", its accounts return to the main list. Accounts and their groups are kept.',
        dissolveDeleteMembers: 'Also delete all {count} accounts in this pool (cannot be undone)',
        dissolved: 'Pool "{name}" dissolved',
        moveToPool: 'Move to another pool',
        release: 'Remove from pool',
        releaseConfirm: 'Remove {count} accounts from the pool? They will return to the main list.',
        releaseSuccess: 'Removed {count} accounts from the pool',
        noMembers: 'No accounts',
        assignTitle: 'Add to account pool',
        assignHint: 'Add {count} accounts to a pool. They will be hidden from the main list (search still finds them).',
        assignExisting: 'Existing pool',
        assignNew: 'New pool',
        selectPool: 'Select a pool',
        assignSuccess: 'Added {count} accounts to the pool',
        assignFailed: 'Failed to add accounts to the pool',
        assignMixedPlatform: 'A pool only holds accounts of one platform; select accounts per platform',
