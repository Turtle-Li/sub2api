export default {
    accounts: {
      ...
      openai: {
        ...
        codexFingerprintModeDesc: 'Disabled by default. When multiple users share the same OAuth account, converge device/session identifiers to account-level stable values to reduce upstream-visible device and session count. Off = pass through client identifiers as-is.',
