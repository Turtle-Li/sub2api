export default {
    ...
    subscriptions: {
      ...
      remainingResetCount: 'Resets: {count}',
      grantResetCards: 'Grant Reset Cards',
      grantResetCardsShort: 'Grant Uses',
      grantResetCardsTitle: 'Grant Reset Cards by Group',
      grantResetCardsDesc: 'Grant reset cards to current active subscribers in the selected groups. Repeated grants stack, and the earliest-expiring cards are used first.',
      grantResetCardsToUserTitle: 'Grant Reset Cards to User',
      grantResetCardsToUserDesc: 'Add reset uses only to the selected subscription row. Other subscriptions owned by this user are not affected.',
      resetCardsForm: {
        target: 'Recipient',
        targetHint: 'Reset cards are attached only to the subscription shown above',
        groups: 'Subscription Groups',
        groupsHint: 'Only active, unexpired subscriptions in the selected groups receive cards',
        count: 'Cards per User',
        directCount: 'Card Count',
        countHint: 'Up to 1000 per grant; repeated grants stack',
        expiresAt: 'Card Expiry',
        expiresAtHint: 'Defaults to two weeks from now; unused cards expire at this time'
      },
      pleaseSelectResetCardGroups: 'Select at least one subscription group',
      invalidResetCardCount: 'Card count must be between 1 and 1000',
      invalidResetCardExpiry: 'Card expiry must be in the future and no later than 2099-12-31',
      resetCardsGranted: 'Granted {cards} reset cards to {recipients} active subscriptions',
      resetCardsGrantedToUser: 'Granted {cards} reset cards to {user} on “{group}”',
      resetCardsNoRecipients: 'No active subscriptions were found in the selected groups; no cards were granted',
      failedToGrantResetCards: 'Failed to grant reset cards',
