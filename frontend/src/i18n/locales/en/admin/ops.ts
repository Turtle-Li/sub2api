export default {
    ops: {
      ...
      network: {
        ...
        invalidSettings: 'Check the bandwidth limits and abnormal retry settings.',
        ...
        retryUseRecommended: 'Restore recommended',
        retryCurrentStrategy: 'Current strategy',
        retryPresetRecommended: 'Recommended',
        retryPresetCustom: 'Custom',
        retryStrategySummary: 'When bandwidth reaches {trigger}%, watch identical large requests for {window} seconds and allow {repeats} repeat(s).',
        retryEstimateSummary: 'Based on {direction} at {limit} Mbps: fingerprint requests from about {candidate}; only consider limiting from attempt {count} after repeated bytes exceed {budget}.',
        retryAdvancedSettings: 'Advanced settings',
        retryAdvancedHint: 'Most sites do not need to change these. Adjust them only to reduce false matches or tune for server capacity.',
        ...
        retryMinBodyHint: 'This only decides when detection begins; it is not a request size limit.',
        ...
        retryProtectionWarning: 'Low-spec servers or concurrent large requests may see extra CPU usage. Keep the recommended settings first, then disable or tune advanced settings if needed.',
