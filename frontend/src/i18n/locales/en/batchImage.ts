export default {
  batchImage: {
    ...
    itemResult: {
      ...
      resultAvailable: 'The result is in private COS. Click to load the preview locally.',
    ...
    guide: {
      ...
      step3: '3. After submission, previews remain unloaded. Clicking an item streams its private COS archive until the browser finds that image, then caches a compressed thumbnail.',
      step4: '4. The browser builds the ZIP locally, so image bodies never pass through the Sub2 Japan server. Failed items can still be retried separately.',
    ...
    messages: {
      ...
      archiveClientFailed: 'The browser could not safely read or parse the private COS result. Check COS CORS, the short-lived signature, and archive integrity.',
