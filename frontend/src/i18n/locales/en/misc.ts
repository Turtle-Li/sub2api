export default {
  ...
  payment: {
    ...
    orderOps: {
      ...
      "existingOrderTitle": "An existing order is already paying",
      ...
      "cancelExistingOrder": "Cancel existing order",
      "cancelOrderConfirmTitle": "Cancel this order?",
      "cancelOrderConfirmMessage": "The payment channel must confirm the cancellation. Cancel the current order?",
