export default {
  ...
  userSubscriptions: {
    ...
    upgradeContactAdmin: 'Contact an administrator to upgrade your plan.',
  ...
  payment: {
    ...
    orderOps: {
      ...
      "resetCardUnitPrice": "Unit price",
      "resetCardUseOnPurchase": "Use on purchase",
      ...
      "paymentExpiresIn": "{time} remaining",
      "paymentExpiryChecking": "Order expired. Checking payment status",
      "cancellationPending": "Cancellation is processing. Do not continue payment",
      "confirmationPending": "Payment status is being confirmed. Do not pay again.",
      "cancelNotice": "After submission, payment status will be confirmed and this checkout will be closed. Do not continue payment.",
      "keepOrder": "Keep order",
      "existingOrderTitle": "You have a pending order",
      "existingOrderMessage": "You already have one unfinished order. Continue that order, or confirm its cancellation before creating a new one.",
      "openExistingOrder": "Continue payment",
      "cancelExistingOrder": "Cancel order",
      "cancelOrderConfirmTitle": "Cancel this order?",
      "cancelOrderConfirmMessage": "Cancel the current order? This checkout will no longer be payable.",
      "cancelFailedRetry": "Couldn't cancel the order. Try again.",
      "retryCancellation": "Retry cancellation",
      "cancelled": "Order cancelled",
      "resetCardTotalPrice": "Item total",
    ...
    resetShop: {
      ...
      quantity: 'Quantity',
      quantitySummary: '{quantity} cards',
      validity: 'Valid until',
      validUntil: 'Valid until {date}',
      useOnPurchase: 'Use one card immediately after purchase succeeds',
      selectFirst: 'Choose a reset card',
      checkout: 'Buy and pay',
    ...
    qr: {
      ...
      cancelled: 'Order Cancelled',
      paymentSheetDismissed: 'Payment window closed. The order status is still being checked.',
    ...
    errors: {
      ...
      PAYMENT_CANCELLATION_PENDING: 'Cancellation is processing. Do not continue payment.',
      PAYMENT_CONFIRMATION_PENDING: 'Payment status is being confirmed. Do not pay again.',
      ...
      REFUND_AMOUNT_TOO_SMALL: 'Refund amount is below the current minimum.',
      REFUND_AMOUNT_EXCEEDED: 'Refund amount exceeds the current refundable limit.',
    ...
    admin: {
      ...
      refundMerchantBalanceInsufficientCompact: 'Merchant balance is insufficient',
      ...
      refundRetryQueuedCompact: 'Refund is queued',
      refundManualReviewCompact: 'Needs review',
      ...
      refundAmountMaximum: 'Maximum {amount}',
      refundAmountMinimum: 'Minimum {amount}',
      refundAmountPreviewing: 'Updating the refund effect…',
      refundAmountInvalid: 'Enter an amount with no more than 2 decimal places.',
      refundAmountTooSmall: 'The amount is below the refundable minimum.',
      refundAmountExceeded: 'The amount exceeds the current refundable maximum.',
      ...
      refundEntitlementTime: 'Time to reclaim',
