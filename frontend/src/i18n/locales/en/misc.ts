export default {
  ...
  payment: {
    ...
    admin: {
      ...
      monthlyResetCardsTitle: 'Monthly reset-card delivery',
      monthlyResetCardsHint: 'Enable scheduled reset cards only after the delivery scheduler is ready. Calendar-month plans then issue the configured count each month.',
      monthlyResetCardsEnabled: 'Enabled',
      monthlyResetCardsDisabled: 'Disabled',
      monthlyResetCardsEnabledSaved: 'Monthly reset-card delivery enabled',
      monthlyResetCardsDisabledSaved: 'Monthly reset-card delivery disabled',
      monthlyResetCardsEnableRequired: 'Enable monthly reset-card delivery in Product Catalog before choosing it for a plan.',
      monthlyResetCardsTermInvalid: 'Monthly delivery requires a calendar month, quarter, or year term that resolves to 2–120 periods.',
      ...
      monthlyResetCardValidityHint: 'Each delivery grants {count} reset card(s), each usable for {days} days from delivery.',
      resetCardExpiryDays: 'Reset Card Validity',
      resetCardExpiryUnit: 'Validity Unit',
      resetCardValidityHint: 'Grants {count} reset(s), usable for {days} days from delivery.',
