export default {
  ...
  payment: {
    ...
    meteredTier: 'Metered',
    rechargeTierName: '{amount} USD credit',
    ...
    concurrencyBonus: 'Concurrency +{count}',
    ...
    entitlements: {
      balanceBonus: 'bonus balance',
      resetCards: 'quota reset(s), valid for {days} days',
    ...
    admin: {
      ...
      resetCardExpiryDays: 'Reset Card Validity (days)',
