export default {
  ...
  userSubscriptions: {
    ...
    noPlatformSubscriptions: 'No subscriptions for this platform.',
    ...
    buyResetCards: 'Buy reset counts',
    resetCardQuantity: 'Quantity',
    resetCardPrice: 'Unit price',
    resetCardValidity: 'Each count is valid for 14 days',
    resetCardPurchaseSuccess: 'Reset-count order created'
  },
  ...
  payment: {
    ...
    result: {
      ...
      resetCardsSuccess: 'Reset counts purchased successfully',
    ...
    errors: {
      ...
      SUBSCRIPTION_PLATFORM_INVALID: 'The subscription platform is unavailable.',
      SUBSCRIPTION_NOT_ACTIVE: 'The current subscription is not active.',
      SUBSCRIPTION_PURCHASE_TERMS_CHANGED: 'Subscription terms changed. Refresh and try again.',
      SUBSCRIPTION_DOWNGRADE_NOT_SUPPORTED: 'Only upgrades to a higher daily price are supported.',
      UPGRADE_SOURCE_TERMS_UNKNOWN: 'This subscription has no historical price, so its upgrade credit cannot be calculated.',
      SUBSCRIPTION_UPGRADE_PRICE_INVALID: 'The upgrade price is invalid. Refresh and try again.',
      RESET_CARD_PURCHASE_INVALID: 'Reset-card quantity must be between 1 and 100.',
      RESET_CARD_SUBSCRIPTION_UNAVAILABLE: 'An active subscription is required to buy reset cards.',
      RESET_CARD_PRICE_UNAVAILABLE: 'This subscription has no recorded price, so reset cards cannot be purchased.',
      RESET_CARD_PRICE_INVALID: 'The reset-card price is invalid. Refresh and try again.',
    ...
    renewNow: 'Renew',
    upgradeNow: 'Upgrade',
    upgradeUnavailable: 'Renew before upgrading',
    upgradeUnavailableHint: 'This subscription predates price tracking. Renew the current plan before upgrading.',
    downgradeNotAvailable: 'Downgrade unavailable',
    remainingTerm: 'prorated for remaining term',
