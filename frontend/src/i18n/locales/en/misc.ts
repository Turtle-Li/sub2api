export default {
  ...
  payment: {
    ...
    resetShop: {
      ...
      "hint": "For active GPT subscriptions. Pay with Alipay or WeChat to reset usage without extending your subscription. Cards expire with the current subscription.",
    ...
    entitlements: {
      ...
      monthlyResetCards: '{count} reset card(s) each month for {issues} periods; each card is valid for {validity}',
