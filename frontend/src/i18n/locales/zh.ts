    ...
    ops: {
      ...
      alertRules: {
        ...
        metrics: {
          ...
          cpu: 'CPU 使用率 (%)',
          memory: '内存使用率 (%)',
          networkBandwidthUtilization: '出入站带宽利用率 (%)',
          networkSaturationSuspected: '疑似带宽拥塞',
          queueDepth: '并发排队深度',
        ...
        metricDescriptions: {
          ...
          networkBandwidthUtilization: '取入站/出站利用率中的较大值；任一方向超过阈值即触发。需要先在带宽卡片设置手动上限。',
          networkSaturationSuspected: '兼容旧规则的布尔指标；新规则建议使用“出入站带宽利用率”。',
        ...
        hints: {
          ...
          bandwidthLimitRequired: '需要先在“公网带宽”卡片里配置入站或出站上限。'
        },
        table: {
          name: '名称',
          metric: '指标',
        ...
        validation: {
          ...
          bandwidthLimitRequired: '带宽利用率告警需要先配置入站或出站上限',
      ...
      network: {
        ...
        retryProtectionWarning: '低配置服务器或高并发大请求场景下，开启后可能增加 CPU 消耗和请求延迟；如出现影响，请调高最小候选请求体或暂时关闭实验功能。',
