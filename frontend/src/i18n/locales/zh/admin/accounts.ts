export default {
    accounts: {
      ...
      proxyPool: {
        ...
        ssoHint: '仅 Grok SSO 导入使用此代理池；每个导入成功的 Grok 账号都会固定到选中的代理。'
      },
      pools: {
        title: '账号池',
        create: '新建账号池',
        ...
        name: '池名称',
        platform: '平台',
        platformHint: '一个池只能容纳同一平台的账号，创建后不可修改；分组、代理、调度仍然绑定在每个账号上。',
        notes: '备注',
        saved: '账号池已保存',
        saveFailed: '保存账号池失败',
        loadFailed: '加载账号池失败',
        ...
        requests: '{count} 次请求',
        usageUpdated: '用量统计 {time} 更新（约每分钟刷新）',
        grokFreeQuota: 'Free 额度',
        grokFreeHint: '池内 Grok Free 账号在额度窗口内已用 token / 总额度',
        codexQuota: 'Codex 平均用量',
        exhausted: '{count} 个已耗尽',
        nearLimit: '{count} 个接近上限',
        editAllMembers: '编辑全部成员',
        purgeError: '清理异常账号（{count}）',
        purgeErrorTitle: '清理异常账号',
        purgeErrorConfirm: '将删除池内 {count} 个异常状态的账号，此操作不可恢复。确认继续？',
        dissolve: '解散账号池',
        dissolveTitle: '解散账号池',
        dissolveConfirm: '解散账号池「{name}」后，池内账号会回到主列表，账号本身及其分组设置不受影响。',
        dissolveDeleteMembers: '同时删除池内全部 {count} 个账号（不可恢复）',
        dissolved: '账号池「{name}」已解散',
        moveToPool: '移动到其他池',
        release: '移出账号池',
        releaseConfirm: '确认将 {count} 个账号移出账号池？它们会回到主列表。',
        releaseSuccess: '已将 {count} 个账号移出账号池',
        noMembers: '暂无账号',
        assignTitle: '加入账号池',
        assignHint: '将 {count} 个账号加入账号池，加入后它们不再显示在主列表中（搜索时仍可找到）。',
        assignExisting: '已有账号池',
        assignNew: '新建账号池',
        selectPool: '选择账号池',
        assignSuccess: '已将 {count} 个账号加入账号池',
        assignFailed: '加入账号池失败',
        assignMixedPlatform: '一个账号池只能包含同一平台的账号，请按平台分别选择',
        importTarget: '导入到账号池',
