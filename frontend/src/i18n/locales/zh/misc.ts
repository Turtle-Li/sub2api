export default {
  ...
  payment: {
    ...
    admin: {
      ...
      monthlyResetCardsTitle: '月度重置卡发放',
      monthlyResetCardsHint: '仅在发卡调度服务已准备好时开启。启用后，日历月订阅会按月发放配置数量的重置卡。',
      monthlyResetCardsEnabled: '已启用',
      monthlyResetCardsDisabled: '未启用',
      monthlyResetCardsEnabledSaved: '已启用月度重置卡发放',
      monthlyResetCardsDisabledSaved: '已关闭月度重置卡发放',
      monthlyResetCardsEnableRequired: '请先在商品配置中启用月度重置卡发放，再为套餐选择此方式。',
      monthlyResetCardsTermInvalid: '月度发放仅支持月、季度或年度有效期，且严格派生后的总期数必须在 2 至 120 期之间。',
      ...
      monthlyResetCardValidityHint: '每期发放 {count} 张重置卡；每张自到账起 {days} 天内有效。',
      resetCardExpiryDays: '重置次数有效期',
      resetCardExpiryUnit: '有效期单位',
      resetCardValidityHint: '购买后发放 {count} 次重置，自到账起 {days} 天内有效。',
