export default {
  ...
  userSubscriptions: {
    ...
    noPlatformSubscriptions: '该平台暂无订阅记录',
    failedToLoad: '加载订阅失败',
    status: {
      active: '有效',
      expired: '已过期',
    ...
    renew: '续费',
    resubscribe: '重新订阅',
    buyResetCards: '购买重置次数',
    resetCardQuantity: '购买数量',
    resetCardPrice: '单次价格',
    resetCardValidity: '每次有效期 14 天',
    resetCardPurchaseSuccess: '重置次数购买订单已创建'
  },
  ...
  payment: {
    ...
    errors: {
      ...
      SUBSCRIPTION_PLATFORM_INVALID: '订阅平台不可用',
      SUBSCRIPTION_NOT_ACTIVE: '当前订阅不是有效状态',
      SUBSCRIPTION_PURCHASE_TERMS_CHANGED: '订阅条款已变化，请刷新后重试',
      SUBSCRIPTION_DOWNGRADE_NOT_SUPPORTED: '当前仅支持升级到更高日均价格的套餐',
      UPGRADE_SOURCE_TERMS_UNKNOWN: '当前订阅缺少历史价格，暂不能计算升级补差价',
      SUBSCRIPTION_UPGRADE_PRICE_INVALID: '升级补差价无效，请刷新后重试',
      RESET_CARD_PURCHASE_INVALID: '重置次数购买数量必须在 1 到 100 之间',
      RESET_CARD_SUBSCRIPTION_UNAVAILABLE: '需要有效订阅才能购买重置次数',
      RESET_CARD_PRICE_UNAVAILABLE: '当前订阅没有可用的价格记录，暂不能购买重置次数',
      RESET_CARD_PRICE_INVALID: '重置次数价格无效，请刷新后重试',
    ...
    renewNow: '续费',
    upgradeNow: '升级',
    upgradeUnavailable: '请先续费后升级',
    upgradeUnavailableHint: '当前订阅缺少历史价格信息，请先续费当前套餐后再升级。',
    downgradeNotAvailable: '暂不支持降级',
    remainingTerm: '剩余有效期补差价',
    selectPlan: '选择套餐',
    planFeatures: '功能特性',
    planCard: {
      rate: '倍率',
