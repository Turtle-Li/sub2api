...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    meta: { requiresAuth: true, requiresAdmin: true, title: 'Codex State Maintenance', titleKey: 'admin.codexTurnState.title', descriptionKey: 'admin.codexTurnState.description' }
  },
  {
    path: '/admin/accounts',
    name: 'AdminAccounts',
