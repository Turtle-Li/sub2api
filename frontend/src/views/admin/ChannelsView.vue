...
import { apiIntervalsToForm, apiTimePricingToForm, createDefaultTimePricingForm, findModelConflict, formIntervalsToAPI, formTimePricingToAPI, isValidPositiveMultiplier, mTokToPerToken, normalizePricingCurrency, perTokenToMTok, validateIntervals, validateTimePricing } from '@/components/admin/channel/types'
      ...
      rules.push({
        ...
        pricing: rule.pricing
          ...
          .map(p => ({
            ...
            currency: normalizePricingCurrency(p.currency),
